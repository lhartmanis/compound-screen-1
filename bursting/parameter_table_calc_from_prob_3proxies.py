...
def sim_and_calc_nums(open_chance, close_chance, transcribe_chance, degrade_chance, time, maxexpr, set_to_zero, prob_fun):
    try:
            ...
            for transcribe_chance in chances(o.transcribe_rate):
                for degrade_chance in chances(o.degrade_rate):
                    for time in chances(o.time):
                        param_list.append((open_chance, close_chance, transcribe_chance, degrade_chance, time, o.maxexpr, o.set_to_zero))
